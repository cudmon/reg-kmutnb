...
module.exports = async (req, res) => {
  db.execute(
    ...
    "SELECT section.section_number,section.section_start,section.section_end ,section.section_day, subject.subject_name ,subject.subject_code ,teacher.teacher_first_name,teacher.teacher_last_name,teacher.teacher_tid FROM section INNER JOIN subject ON section.subject_id = subject.subject_id INNER JOIN teacher ON  section.teacher_id = teacher.teacher_id",
    (err, result) => {
